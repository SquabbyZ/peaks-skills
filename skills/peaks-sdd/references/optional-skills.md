...
| design | Primary: `design-taste-frontend` + design agent. Landing zone: `ui-ux-pro-max`. Fallback: `frontend-design`. Optional: `design-shotgun`, `design-html`, `design-md` | Better visual direction, stronger UI taste, UX depth, design variants, production HTML mockups, design specs | Use Design Dials, Anti-Slop rules, auto-served HTML preview, design spec, and screenshots |
